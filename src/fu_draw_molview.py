...
sys.path.insert(0,'./fu_module')

#import fu_lib as lib
import lib
...
class CanvasDraw():
    ...
    def __init__(self,parent,parwin,canpos,cansize,viewhdr):
        ...
        self.drwitemlst=['Distance','Tube','CAlpha','BDA points','xyz-axis',
            ...
            'Atom name+number','Element','cube-data'] # <--- too heavy
    ...
    def InitGL(self):
        ...
        if not self.gl_initialized:
            ...
            # wx.MessageBox('gl_initialized='+str(self.gl_initialized))
        # wx.MessageBox('InitGL ok0')
        light_diffuse = [1.0, 1.0, 1.0, 1.0]
        light_position = [self.eyepos[0], self.eyepos[1], self.eyepos[2], 0.0]
        # wx.MessageBox('InitGL ok1')
        #
        glLightfv(GL_LIGHT0, GL_DIFFUSE, light_diffuse)
        glLightfv(GL_LIGHT0, GL_POSITION, light_position)
        # wx.MessageBox('InitGL ok2')
        #
        glEnable(GL_LIGHTING)
        glEnable(GL_LIGHT0)
        glEnable(GL_DEPTH_TEST)
        # wx.MessageBox('InitGL ok3')
        glClearColor(self.bgcolor[0], self.bgcolor[1], self.bgcolor[2],
                     self.bgcolor[3])
        glClearDepth(1.0)
        #
        # wx.MessageBox('InitGL ok4')
        self.gl_initialized = True
    ...
    def Draw(self):
        ...
        #    mess=mess+'Quit the program.'            
        #    wx.MessageBox(mess,'fu_draw.Draw',wx.OK)
        #    try: self.viewhdr.Quit()
        #    except: pass
    ...
    def FindCenter(self,mol):
        ...
        for atom in mol.atm:
            ...
            nmol += 1
        xave = xsum / float(nmol); yave = ysum / float(nmol)
