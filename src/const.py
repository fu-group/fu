...
VERSION='fu-0.5.3'
COPYRIGHT="Copyright (c) 2013-2019, Fu User Group.\n All rights reserved.\n"
#
FUVER='fu version 0.5.2 (April 12, 2019)'
...
MDLWIN=None
MESSAGELEVEL=1
MAXSPHERE=40000 # maximum number of sheres on WINDOWS
# import module
OPENBABEL = False
PYBEL     = False
RDKIT     = False
...
ElmCov={' H':0.3,  'HE':1.5,  'LI':1.225, 'BE':1.06, ' B':0.88,
        ...
        ' W':1.46, ' D':0.3,  ' X':0.00,'XX':0.0, '??':0.0}
...
# should be replaced with more reasonable data. 
# hydrogen bonding elements
HbndElm = [' O',' N',' S']
# hydrogen bond length [median,min,max]
HBndLen  = {' N N':[3.0,2.5,3.3],' N O':[3.0,2.5,3.3],' N S':[3.3,2.8,3.6],
           ' O O':[3.0,2.5,3.2],' O S':[3.3,2.8,3.6],' S S':[3.6,3.0,3.8] }
# hydrigen ond angle [min,max]
HBndAng  = [140.0,180]
...
AmiResBnd={'ALA':{' N  ':[['-C  ',1],[' CA ',1]],
            ...
            'TRP':{' N  ':[['-C  ',1],[' CA ',1]],
                   ...
                   ' CG ':[[' CB ',1],[' CD1',4],[' CD2',4]],
                   ' CD1':[[' CG ',4],[' NE1',4]],
                   ' CD2':[[' CG ',4],[' CE2',4],[' CE3',4]],
                   ' NE1':[[' CD1',4],[' CE2',4]],
                   ' CE2':[[' CD2',4],[' NE1',4],[' CZ2',4]],
                   ' CE3':[[' CD2',4],[' CZ3',4]],
                   ' CZ2':[[' CE2',4],[' CH2',4]],
                   ' CZ3':[[' CE3',4],[' CH2',4]],
                   ' CH2':[[' CZ2',4],[' CZ3',4]]},
...
# pdbget http://www.rcsb.org/pdb/rest/customReport.xml?pdbids=
# 1stp,2jef,1cdg&customReportColumns=structureId,structureTitle,experimentalTechnique
WebAddress = {'PCCDB'   : 'http://pccdb.org',
              'PubChem' : 'https://pubchem.ncbi.nlm.nih.gov/search/search.cgi',
              'PDB'     : 'https://www.rcsb.org/pdb/home/home.do',
              'PDBget'  : 'http://www.rcsb.org/pdb/rest/customReport.xml?pdbids=' # + pdbid
              }